...
--
-- Name: categories; Type: TABLE; Schema: public; Owner: dmauler
--
...
ALTER TABLE public.categories OWNER TO dmauler;

--
-- Name: categories_id_seq; Type: SEQUENCE; Schema: public; Owner: dmauler
--
...
ALTER TABLE public.categories_id_seq OWNER TO dmauler;

--
-- Name: categories_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: dmauler
--
...
--
-- Name: questions; Type: TABLE; Schema: public; Owner: dmauler
--
...
ALTER TABLE public.questions OWNER TO dmauler;

--
-- Name: questions_id_seq; Type: SEQUENCE; Schema: public; Owner: dmauler
--
...
ALTER TABLE public.questions_id_seq OWNER TO dmauler;

--
-- Name: questions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: dmauler
--
...
--
-- Name: categories id; Type: DEFAULT; Schema: public; Owner: dmauler
--
...
--
-- Name: questions id; Type: DEFAULT; Schema: public; Owner: dmauler
--
...
--
-- Data for Name: categories; Type: TABLE DATA; Schema: public; Owner: dmauler
--
...
--
-- Data for Name: questions; Type: TABLE DATA; Schema: public; Owner: dmauler
--
...
59	Sci Question 1	Sci Answer 1	1	1
60	Sci Question 2	Sci Answer 2	1	1
61	Art question 1	Art Answer 1	1	2
62	Geo 1	Geo 1	1	3
63	Geo 2	Geo 2	1	3
64	Hist1	Hist1	4	4
65	Enter1	Enter1	1	5
66	Enter2	Enter2	1	5
67	Sport1	Sport1	1	6
68	Sport2	Sport2	5	6
69	Sport3	Sport3	1	6
70	sci3	sci3	1	1
71	Art2	Art2	1	2
72	Geo3	Geo3	1	3
73	History2	History2	3	4
74	Enter3	Enter3	2	5
75	Baseball1	Baseball1	5	6
\.


--
-- Name: categories_id_seq; Type: SEQUENCE SET; Schema: public; Owner: dmauler
--
...
--
-- Name: questions_id_seq; Type: SEQUENCE SET; Schema: public; Owner: dmauler
--
...
--
-- Name: categories categories_pkey; Type: CONSTRAINT; Schema: public; Owner: dmauler
--
...
--
-- Name: questions questions_pkey; Type: CONSTRAINT; Schema: public; Owner: dmauler
--
...
--
-- Name: questions category; Type: FK CONSTRAINT; Schema: public; Owner: dmauler
--
